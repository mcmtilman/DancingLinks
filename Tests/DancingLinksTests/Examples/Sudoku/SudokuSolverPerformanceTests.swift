...
class SudokuSolverPerformanceTests: XCTestCase {
    ...
    func testSolveQQWingSudokus() {
        let sudokus = Self.qqwingSudokus.components(separatedBy: "\n").compactMap { Sudoku.init(string: $0, format: .line) }
    ...
    // Test solving the Inkala sudokus.
    func testSolveInkalaSudokus() {
        measure {
...
/**
 "Top ten" Inkala and 50 QQWing expert sudokus
 */
extension SudokuSolverPerformanceTests {
    
    static let inkalaSudokus = [
        "escargot": Sudoku(string: """
            1....7.9.
            .3..2...8
            ..96..5..
            ..53..9..
            ...
            ..7...3..
            """)!,
        "killer application": Sudoku(string: """
            .......7.
            .6..1...4
            ..34..2..
            8....3.5.
